...
public final class PictureConfig {
    ...
    public final static int CHOOSE_REQUEST = 188;//图片
    public final static int CHOOSE_REQUEST_TWO = 187;//图片
    public final static int CHOOSE_REQUEST_VOIDE = 189;//视频
    public final static int CHOOSE_REQUEST_FREQ = 190;//音频
